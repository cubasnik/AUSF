    ...
    try:
        ...
        try:
            client._call(
                ...
                {"eapPayload": "EAP-Response/AKA'-Challenge token"},
            )
            ...
            print(f"eap-payload-rejected-error: {error.payload}")
        else:
            raise AssertionError("expected 400 INVALID_CONFIRMATION_PAYLOAD for 5G_AKA confirmation with eapPayload")
