...
def main() -> int:
    ...
    try:
        ...
        try:
            client.confirm_authentication(challenge["authCtxId"], expected_res_star)
            ...
            raise AssertionError("expected 401 AUTHENTICATION_REJECTED for repeated confirmation after success")
