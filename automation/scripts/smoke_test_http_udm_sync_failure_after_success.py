...
def main() -> int:
    ...
    try:
        ...
        refreshed = client.confirm_authentication_with_auts(
            challenge["authCtxId"],
            initial_control_plane_context["auts"],
        )
        ...
        confirmed = client.confirm_authentication(
            challenge["authCtxId"],
        ...
        try:
            client.confirm_authentication_with_auts(
                challenge["authCtxId"],
                refreshed_control_plane_context["auts"],
            )
            ...
            raise AssertionError(
                "expected 401 AUTHENTICATION_REJECTED for synchronization-failure after success"
            )
