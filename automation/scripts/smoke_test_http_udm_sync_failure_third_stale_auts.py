...
def main() -> int:
    ...
    try:
        ...
        try:
            client.confirm_authentication_with_auts(challenge["authCtxId"], second_auts)
            ...
            print(f"stale-third-refresh-auts-authentication-rejected-error: {error.payload}")
        else:
            raise AssertionError(
                "expected 401 AUTHENTICATION_REJECTED for stale AUTS after third 5G_AKA re-sync refresh"
            )
