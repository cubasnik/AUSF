...
def main() -> int:
    ...
    try:
        ...
        assert first_sync_failure["authResult"] == "ONGOING"
        assert first_sync_failure["eapSession"]["payload"] != challenge["eapSession"]["payload"]
        ...
        assert first_refreshed_context["eapSession"]["payload"] == first_sync_failure["eapSession"]["payload"]
        ...
        assert second_sync_failure["authResult"] == "ONGOING"
        assert second_sync_failure["eapSession"]["payload"] != first_sync_failure["eapSession"]["payload"]
        ...
        assert second_refreshed_context["eapSession"]["payload"] == second_sync_failure["eapSession"]["payload"]
