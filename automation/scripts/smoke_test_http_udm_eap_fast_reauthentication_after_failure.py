    ...
    try:
        ...
        try:
            ...
            raise AssertionError(
                "expected 401 AUTHENTICATION_REJECTED for stale eapPayload after fast re-auth refresh"
            )
        ...
        try:
            ...
            print(f"repeat-fast-reauth-rejected-error: {error.payload}")
        else:
            raise AssertionError(
                "expected 401 AUTHENTICATION_REJECTED for fast re-authentication after failure"
            )
