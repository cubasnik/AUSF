...
def main() -> int:
    ...
    try:
        ...
        confirmed = client.confirm_authentication(challenge["authCtxId"], control_plane_context["xresStar"])
        ...
        try:
            client.confirm_authentication_with_auts(challenge["authCtxId"], auts)
            ...
            raise AssertionError("expected 401 AUTHENTICATION_REJECTED for repeated AUTS confirmation after success")
