...
def main() -> int:
    ...
    try:
        ...
        try:
            client.confirm_authentication_with_auts(challenge["authCtxId"], first_auts)
            ...
            raise AssertionError(
                "expected 401 AUTHENTICATION_REJECTED for stale AUTS after second 5G_AKA re-sync refresh"
            )
