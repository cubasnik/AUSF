...
func NewAuthService(controlPlaneClient *controlplane.Client) *AuthService {
    return &AuthService{contexts: make(map[string]AuthContext), controlPlaneClient: controlPlaneClient}
}
